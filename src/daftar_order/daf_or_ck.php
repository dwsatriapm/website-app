      ...
      <div class="card-body">
         <div class="tabel-kontainer">
            <table class="tabel-transaksi">
               ...
               <tbody>
                  <?php
                  $cuci_komplit = query('SELECT * FROM tb_order_ck ORDER BY id_order_ck ASC');
                  if (!empty($cuci_komplit)) : ?>
                     ...
                     foreach ($cuci_komplit as $ck) : ?>
                        <tr>
                           ...
                           <td><?= formatDate($ck['tgl_masuk_ck']) ?></td>
                  ...
                  <?php else : ?>
                     <tr>
                        <td colspan="7" class="txt-center">Data Tidak Tersedia</td>
                     </tr>
                  <?php endif ?>
               </tbody>
            </table>

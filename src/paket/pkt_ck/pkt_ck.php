		...
		<div class="baris">
			<div class="selamat-datang">
				...
				<div class="col-header txt-right">
					<a href="<?= url('paket/pkt_ck/tambah.php') ?>" class="btn-lg bg-primary" style="color: whitesmoke;">+ Tambah Paket</a>
				</div>
			</div>
		</div>
				...
				<div class="card">
					<div class="card-title card-flex">
						...
						<div class="card-col txt-right">
							<a href="<?= url('paket/paket.php') ?>" class="btn-xs bg-primary" style="color: whitesmoke;">Kembali</a>
						</div>
					</div>

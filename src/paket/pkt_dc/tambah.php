   ...
   <?php if (add_dc($_POST) > 0) : ?>
      <div class="alert">
         <div class="box">
            ...
            <button onclick="window.location='http://localhost:4124/paket/pkt_dc/pkt_dc.php'" class="btn-alert">Ok</button>
         </div>
      </div>
            ...
            <div class="card">
               <div class="card-title card-flex">
                  ...
                  <div class="card-col txt-right">
                     <a href="<?= url('paket/pkt_dc/pkt_dc.php') ?>" class="btn-xs bg-primary" style="color: whitesmoke;">Kembali</a>
                  </div>
               </div>
               ...
               <div class="card-body">
                  <form action="" method="post" class="form-input">
                     ...
                     <div class="form-grup ">
                        <button type="submit" class="mt-1" name="tambah" style="color: whitesmoke;">Tambah</button>
                     </div>
                  </form>
               </div>
            </div>

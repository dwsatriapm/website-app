            ...
            <div class="card">
               <div class="card-title card-flex">
                  ...
                  <div class="card-col txt-right">
                     <a href="<?= url('order/order.php') ?>" class="btn-xs bg-primary" style="color: whitesmoke;">Kembali</a>
                  </div>
               </div>
               ...
               <div class="card-body">
                  <form action="" method="post">
                     ...
                     <div class="form-footer">
                        <div class="buttons">
                           <button type="submit" name="order_dc" class="btn-sm bg-primary" style="color: whitesmoke;">Pesan</button>

...
<?php if (isset($_POST['bayar_ck'])) : ?>
   <script>
      window.location = "http://localhost:4124/detail_order/detail_ck/bayar.php?or_ck_number=<?= $no_ck ?>"
   </script>
<?php endif ?>
               ...
               <div class="card-body">
                  <form action="" method="post">
                     ...
                     <div class="form-footer_detail">
                        <div class="buttons">
                           <button type="submit" name="bayar_ck" class="btn-sm bg-primary" style="color: whitesmoke;">Bayar Sekarang</button>
                        </div>

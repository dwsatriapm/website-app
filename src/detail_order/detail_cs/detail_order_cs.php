...
<?php if (isset($_POST['bayar_cs'])) : ?>
   <script>
      window.location = "http://localhost:4124/detail_order/detail_cs/bayar.php?or_cs_number=<?= $no_cs ?>"
   </script>
<?php endif ?>
               ...
               <div class="card-body">
                  <form action="" method="post">
                     ...
                     <div class="form-footer_detail">
                        <div class="buttons">
                           <button type="submit" name="bayar_cs" class="btn-sm bg-primary" style="color: whitesmoke;">Bayar Sekarang</button>
                        </div> <a href="<?= url('dashboard.php') ?>" class="btn-back" style="margin-left: 10px;">← Kembali</a>
                     </div>
                  </form>
               </div>
            </div>

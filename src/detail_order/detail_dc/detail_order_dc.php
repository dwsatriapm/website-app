...
<?php if (isset($_POST['bayar_dc'])) : ?>
   <script>
      window.location = "http://localhost:4124/detail_order/detail_dc/bayar.php?or_dc_number=<?= $no_dc ?>"
   </script>
<?php endif ?>
               ...
               <div class="card-body">
                  <form action="" method="post">
                     ...
                     <div class="form-footer_detail">
                        <div class="buttons">
                           <button type="submit" name="bayar_dc" class="btn-sm bg-primary" style="color: whitesmoke">Bayar Sekarang</button>
                        </div>

...
<head>
    ...
    <title>Nota Order - <?= $data['or_dc_number'] ?></title>
...
<body>
    <div class="nota">
        ...
        <div class="row">
            <span>Tanggal:</span>
            <span><?= date('d/m/Y', strtotime($data['tgl_masuk_dc'])) ?></span>
        </div>
        <div class="row">
            <span>Pelanggan:</span>
            <span><?= $data['nama_pel_dc'] ?></span>
        </div>
        <div class="row">
            <span>Telepon:</span>
            <span><?= $data['no_telp_dc'] ?></span>
        </div>
        ...
        <div class="row">
            <span>Paket:</span>
            <span><?= $data['jenis_paket_dc'] ?></span>
        </div>
        <div class="row">
            <span>Waktu Kerja:</span>
            <span><?= $data['wkt_krj_dc'] ?></span>
        </div>
        <div class="row">
            <span>Berat:</span>
            <span><?= $data['berat_qty_dc'] ?> Kg</span>
        </div>
        <div class="row">
            <span>Harga/Kg:</span>
        ...
        <div class="row">
            ...
            <span><?= date('d/m/Y', strtotime($data['tgl_keluar_dc'])) ?></span>
        </div>

        ...
        <div class="baris">
            <div class="selamat-datang">
                <div class="col-header">
                    ...
                    <p class="judul-sm">No Order: <?= $data['or_cs_number'] ?></p>
                </div>
            </div>
        </div>
            ...
            <div class="col mt-2">
                <div class="card-md">
                    <div class="card-title">
                        <h2>Informasi Order - Cuci Satuan</h2>
                    </div>
                    <div class="card-body">
                        <table class="tabel-detail">
                            <tr>
                                <td><strong>Nomor Order</strong></td>
                                <td><?= $data['or_cs_number'] ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><span class="badge-primary"><?= $data['jenis_paket_cs'] ?></span></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><?= date('d F Y', strtotime($data['tgl_masuk_cs'])) ?></td>
                            </tr>
                            <tr>
                                <td><strong>Estimasi Selesai</strong></td>
                                <td><?= date('d F Y', strtotime($data['tgl_keluar_cs'])) ?></td>
                            </tr>
                            <tr>
                                <td><strong>Keterangan</strong></td>
                                <td><?= $data['keterangan_cs'] ?: '-' ?></td>
                            </tr>
                            <tr>
                        ...
                        <div class="form-footer" style="margin-top: 30px;">
                            ...
                            <div class="buttons">
                                <a href="<?= url('detail_order/detail_cs/bayar.php?or_cs_number=' . $data['or_cs_number']) ?>" 
                                   class="btn-sm bg-success" style="color: white;">
                                    Bayar Sekarang
                                </a>
                                <a href="<?= url('pelanggan/detail_order/cetak_cs.php?or_cs_number=' . $data['or_cs_number']) ?>" 

               ...
               <?php if (!empty($query_dc)) : ?>
                  ...
                  foreach ($query_dc as $data_dc) : ?>
                     <tr>
                        ...
                        <td align="center">
                           <a href="<?= url('riwayat_transaksi/riwayat_dc/detail_dc.php') ?>?id_dc=<?= $data_dc['id_dc'] ?>" class="btn btn-detail">Detail</a><br />
                           <a href="<?= url('riwayat_transaksi/riwayat_dc/cetak_info.php') ?>?id_dc=<?= $data_dc['id_dc'] ?>" class="btn btn-edit" style="color: whitesmoke;">Cetak Bukti</a>
                           <a href="<?= url('riwayat_transaksi/hapus_riwayat.php?type=dc&id=' . $data_dc['id_dc']) ?>"
                              class="btn btn-hapus"
                              onclick="return confirm('Yakin ingin menghapus riwayat transaksi ini?\n\nNo Order: <?= $data_dc['or_number'] ?>\nPelanggan: <?= $data_dc['pelanggan'] ?>')">
                              Hapus
                           </a>
                        </td>
                     </tr>

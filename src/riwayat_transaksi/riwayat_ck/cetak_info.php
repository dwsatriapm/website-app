   ...
   <div class="invoice">
      <div class="invoice-content">
         <div class="invoice-header">
            <div class="logo">
               <img src="<?= url('/assets/img/logo/logo.png') ?>" width="145" alt="Logo Luandry Kami">
            </div>
         ...
         <div class="invoice-body">
            ...
            <div class="invoice-footer">
               <h3 class="foot_logo"><span>Laundry</span> Kami</h3>
      ...
      <div class="printbtn" id="btnPrint">
         <img src="<?= url('/assets/img/printer.svg') ?>" width="48" alt="print icon">

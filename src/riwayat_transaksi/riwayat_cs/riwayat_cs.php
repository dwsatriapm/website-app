               ...
               <?php if (!empty($query_cs)) : ?>
                  ...
                  <?php foreach ($query_cs as $data_cs) : ?>
                     <tr>
                        ...
                        <td align="center">
                           <a href="<?= url('riwayat_transaksi/riwayat_cs/detail_cs.php') ?>?id_cs=<?= $data_cs['id_cs'] ?>" class="btn btn-detail">Detail</a><br />
                           <a href="<?= url('riwayat_transaksi/riwayat_cs/cetak_info.php') ?>?id_cs=<?= $data_cs['id_cs'] ?>" class="btn btn-edit" style="color: whitesmoke;">Cetak Bukti</a>
                           <a href="<?= url('riwayat_transaksi/hapus_riwayat.php?type=cs&id=' . $data_cs['id_cs']) ?>"
                              class="btn btn-hapus"
                              onclick="return confirm('Yakin ingin menghapus riwayat transaksi ini?\n\nNo Order: <?= $data_cs['or_number'] ?>\nPelanggan: <?= $data_cs['pelanggan'] ?>')">
                              Hapus
                           </a>
                        </td>
                     </tr>
